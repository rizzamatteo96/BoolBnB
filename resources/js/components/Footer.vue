<template>
    ...
    <!-- Footer -->
    <footer class="text-center text-lg-start text-white" style="background-color: rgb(0 0 0 / 59%)">
        <!-- Section: Social media -->
        <section class="d-flex justify-content-between p-4" style="background-color: rgb(255 56 91 / 28%)"
                >
        <!-- Left -->
        <div class="me-5">
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #FF385B; height: 2px"/>
                        <p>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2021 Copyright:
            <a class="text-white" href="#">Team 1 Boolean</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
